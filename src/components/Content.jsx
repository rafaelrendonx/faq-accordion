...
export const Content = ({ title, text }) => {
    ...
    return (
        <>
            <div className='px-5 pb-5 desktop:pl-10 desktop:pt-6 desktop:pr-2'>
                <div className='flex flex-row items-center justify-between desktop:justify-self-stretch desktop:pr-0'>
                    ...
                    {isActive ?
                        <img src={iconMinus} alt="minus icon" onClick={setAccordion} className="desktop:pr-[2.1rem]"/> :
                        <img src={iconPlus} alt="plus icon" onClick={setAccordion} className="desktop:pr-[2.1rem] desktop:pl-[0.5rem]"/>}
                </div>
